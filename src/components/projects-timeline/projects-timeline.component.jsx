...
import L_MernTipCalc from "../../assets/img/projects/netflix.png";
import L_Whatsapp from "../../assets/img/projects/whatsapp.png";
import L_SmartBrain from "../../assets/img/projects/facebook.png";
import L_RoboFriends from "../../assets/img/projects/covid.png";
...
<ImageEvent
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong>This is a clone of Netflix website made with react.js and firebase.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="http://netflix-clone-5966a.web.app/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> Its a clone of whatsapp made with react.js , firebase and Material-ui.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>Make rooms for chats</li>
                          <li>google login authantification</li>
                        </ul>
                        <hr />
                        <strong>Tech used:</strong>
                        <ul>
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="http://whatsapp-clone-f660a.web.app/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> A Clone of facebook with proper functionality.
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://facebook-clone-7114b.web.app/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
...
track the information about covid in difrrent country.
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>google map traces with effected areas</li>
                          <li>graph shows the range of effected persons</li>
                        </ul>
                        <hr />
                        <strong>Tech used:</strong>
                        <ul>
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://covid-19-tracker-9a835.web.app/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
